const movies = [
  ...
  function getAllDirectors() {
    ...
    function howManyMovies(allmovie) {
        const Stevenmovies = allmovie.filter(function (movie) {
          return (
...
const totalaveragescore= arr.reduce((acc, cValue) => 
     acc + cValue.score,  sum) / arr.length;
...
function dramaMoviesScore(alldrama) {
    const dramamovi = alldrama.filter(function (movie) {
      return (
    ...
    let total = 0;
    for (let i = 0; i < dramamovi.length; i++){
  }
    const totalaverage= dramamovi.reduce((a,b)=> a + b.score, total);
     total / dramamovi.length
  ...
  console.log(dramaMoviesScore(movies))
      ...
      function orderByYear(){
        ...
        const allsorted = Object.assign(sorted, movies)
        return allsorted
...
function orderAlphabetically(){
    ...
    ///
     ...
     const coPyarry = Object.assign(movies)
            
    console.log(orderAlphabetically(coPyarry))